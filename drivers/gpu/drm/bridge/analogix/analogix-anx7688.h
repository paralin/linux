...
#ifndef LOG_TAG
#define LOG_TAG "anx7688dp"
#endif

#define ANX7688_DRV_VERSION "0.1.04"
...
struct anx7688_platform_data {
	...
	struct anx7688_device_node node;
	struct typec_port *port;
	struct typec_partner *partner;
	struct usb_pd_identity partner_identity;
};

struct anx7688_i2c_client {
